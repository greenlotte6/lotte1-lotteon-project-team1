...
import com.example.lotteon.repository.cs.ReplyRepository;
        ...
        if (optReply.isPresent()) {
            ...
            ReplyDTO replyDTO = ReplyDTO.builder()
                    ...
                    .qna(QnaDTO.builder()
                            ...
                            .member_id(reply.getQna().getMember_id().getUserCompositeKey().getUser().getId()) // DTO용 member_id
                            ...
                            .user_id(reply.getQna().getMember_id().getUserCompositeKey().getUser().getId()) // 추가필드
